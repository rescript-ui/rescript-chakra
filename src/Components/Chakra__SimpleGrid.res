...
let makeProps = (
  ...
  makeProps(
    ...
    /**
      Grid
     **/
    ~gridGap=?gap->withShorthand(gridGap)->GridGap.fromOption,
    ~gridRowGap=?rowGap->withShorthand(gridRowGap)->GridRowGap.fromOption,
    ~gridColumnGap=?columnGap->withShorthand(gridColumnGap)->GridColumnGap.fromOption,
    ~gridColumn=?column->withShorthand(gridColumn)->GridColumn.fromOption,
    ~gridRow=?row->withShorthand(gridRow)->GridRow.fromOption,
    ~gridArea=?area->withShorthand(gridArea)->GridArea.fromOption,
    ~gridAutoFlow=?autoFlow->withShorthand(gridAutoFlow)->GridAutoFlow.fromOption,
    ~gridAutoRows=?autoRows->withShorthand(gridAutoRows)->GridAutoRows.fromOption,
    ~gridAutoColumns=?autoColumns->withShorthand(gridAutoColumns)->GridAutoColumns.fromOption,
    ~gridTemplateRows=?templateRows->withShorthand(gridTemplateRows)->GridTemplateRows.fromOption,
    ~gridTemplateColumns=?templateColumns
    ->withShorthand(gridTemplateColumns)
    ->GridTemplateColumns.fromOption,
    ~gridTemplateAreas=?templateAreas
    ->withShorthand(gridTemplateAreas)
    ->GridTemplateAreas.fromOption,
    /**
      Background
     **/
