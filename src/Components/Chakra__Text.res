...
external make: (
  ...
  ~decoration: Identity.t=?,
  ~size: string=?,
  ~variant: string=?,
  ~noOfLines: Identity.t=?,
  /**
    Margin and Padding
...
let makeProps = (
  ...
  makeProps(
    /**
      Component Props {Text}
     **/
    ~noOfLines=?noOfLines->NoOfLines.fromOption,
    /**
      Margin and Padding
     **/
    ...
    ~textAlign=?align->withShorthand(textAlign)->TextAlign.fromOption,
    ~fontStyle=?fontStyle->FontStyle.fromOption,
    ~textTransform=?casing->withShorthand(textTransform)->TextTransform.fromOption,
    ~textDecoration=?decoration->withShorthand(textDecoration)->TextDecoration.fromOption,
    /**
      Layout Width and Height
     **/
