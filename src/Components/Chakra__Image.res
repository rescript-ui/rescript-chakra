...
external make: (
  ...
  ~sizes: Identity.t=?,
  ~ignoreFallback: bool=?,
  ~htmlHeight: Identity.t=?,
  ~htmlWidth: Identity.t=?,
  ~fit: Identity.t=?,
  ~fallbackSrc: string=?,
  ~fallback: React.element=?,
  ~crossOrigin: [@as("") #empty | #anonymous | @as("use-credentials") #useCredentials]=?,
  ~align: Identity.t=?,
  /**
    Margin and Padding
  ...
  ~onLoad: ReactEvent.Image.t=?,
  ~onError: ReactEvent.Image.t=?,
  /**
    ReactEvent Other
...
let makeProps = (
  ...
  makeProps(
    ...
    ~htmlHeight=?htmlHeight->StringOrNumber.fromOption,
    ~htmlWidth=?htmlWidth->StringOrNumber.fromOption,
    ~fit=?fit->ObjectFit.fromOption,
    ~align=?align->BackgroundPosition.fromOption,
    /**
      Margin and Padding
     **/
