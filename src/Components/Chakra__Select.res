...
external make: (
   ...
   **/
  ~_as: string=?,
  ~errorBorderColor: Identity.t=?,
  ~focusBorderColor: Identity.t=?,
  ~icon: React.element=?,
  ~iconColor: Identity.t=?,
  ~iconSize: string=?,
  ~isTruncated: bool=?,
  ~isDisabled: bool=?,
  ~isFullWidth: bool=?,
...
let makeProps = (
  ...
  makeProps(
    /**
      Component Props {Select}
     **/
    ~errorBorderColor=?color->Color.fromOption,
    ~focusBorderColor=?color->Color.fromOption,
    ~iconColor=?color->Color.fromOption,
