...
let makeProps = (
  ...
  makeProps(
    ...
    ~isInline=?isInline->Bool.fromOption,
    ...
    ~justifyContent=?justify->withShorthand(justifyContent)->JustifyContent.fromOption,
    ~flexWrap=?wrap->withShorthand(flexWrap)->FlexWrap.fromOption,
    ~flexDirection=?direction
    ->withShorthand(flexDir)
    ->withShorthand(flexDirection)
    ->FlexDirection.fromOption,
    ~flex=?flex->Flex.fromOption,
    ~flexGrow=?grow->withShorthand(flexGrow)->FlexGrow.fromOption,
    ~flexShrink=?shrink->withShorthand(flexShrink)->FlexShrink.fromOption,
    ~flexBasis=?basis->withShorthand(flexBasis)->FlexBasis.fromOption,
